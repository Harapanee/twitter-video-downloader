...
const ALLOWED_HOSTS_RE = /^(video\.twimg\.com|video\.twimg-image\.cc|video\.twimg-com\.com|videy\.vedio\.cc|[a-z0-9-]+\.videy-com\.cc|[a-z0-9-]+\.twimg\.com|[a-z0-9-]+\.twimg-com\.com|[a-z0-9-]+\.akamaized\.net|[a-z0-9-]+\.fun800\.click|[a-z0-9-]+\.fun800\.cc|[a-z0-9-]+\.io-d\.cc|api\.fxtwitter\.com|(www\.)?gofile\.beauty|[a-z0-9-]+\.slicedrive\.com)$/;
